...
4. Si el número es múltiplo de 5, imprime "Buzz".
   4.1 Ocupar la exprsión numero % 5
   4.2 es verdadero si el modulo es = 0
5. Si el número es múltiplo de 3 y 5, imprime "FizzBuzz".
   5.1 ocupar la expresion número % 3 y modulo % 5
   5.2 es verdadero solo y solo si ambas exprsiones son = 0
6. en caso de no ser multiplo de ninguno, imprime el numero
*/
/**
 * == solo verifica que sea el mismo valor
 * === verifica que sea el mismo tipo de dato
 */
